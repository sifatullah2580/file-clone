...
def banner():
   ...
   __  ______      ___  _______  _____  __
  /  |/  / _ \____/ _ \/ __/ _ \/ _ \ \/ /
 / /|_/ / , _/___/ , _/ _// // / // /\  / 
/_/  /_/_/|_|   /_/|_/___/____/____/ /_/  
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m𝐒𝐈𝐅𝐀𝐓𝐔𝐋𝐋𝐀𝐇
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m016*******
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m𝑺𝑰𝑭𝑨𝑻𝑼𝑳𝑳𝑨𝑯2580
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [𝑹𝒆𝒅𝒅𝒚] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [𝑹𝒆𝒅𝒅𝒚-CP] %s|%s        '%(b,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/profile.php?id=100044207898905")
	menu()
